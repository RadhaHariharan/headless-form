import type { Action, AnyAction } from '@headlesskit/state-management'
import type { ThunkMiddleware } from './thunkMiddlewareTypes'

export type { ThunkAction, ThunkActionDispatch, ThunkDispatch, ThunkMiddleware } from './thunkMiddlewareTypes'
...
function createThunkMiddleware<State = any, BasicAction extends Action = AnyAction, ExtraThunkArg = undefined>(
  ...
  // Standard middleware definition pattern: a function that wraps `dispatch`.
