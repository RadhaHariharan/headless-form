...
/**
 * Uses an "auto-tracking" approach that tracks fine-grained property access instead of comparing whole references.
 ...
 * ```ts
 * import { unstable_autotrackMemoize as autotrackMemoize, createSelector } from '@headlesskit/state-management-toolkit'
 *
 ...
 * ```ts
 * import { unstable_autotrackMemoize as autotrackMemoize, createSelectorCreator } from '@headlesskit/state-management-toolkit'
 *
