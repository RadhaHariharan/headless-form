 ...
 * @template State - The first value, often a root state object.
...
> = Distribute<
     ...
     *
     * @param state - The first argument, often a root state object.
...
> {
    /**
     * This module performs additional checks in development mode to help identify
...
/**
 * Represents the additional properties attached to a function memoized by this module.
 *
