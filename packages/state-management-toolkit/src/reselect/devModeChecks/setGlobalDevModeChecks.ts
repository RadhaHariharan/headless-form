 ...
 *
 * This module performs additional checks in development mode to help identify and
 ...
 * See {@linkcode CreateSelectorOptions.identityFunctionCheck identityFunctionCheck} for more details.
 *
